...
//    this.dragged = this.selected = null;
    ...
    //something about drawing the graph box & lines:    
    ...
    yrange4 = yrange2 / 2,
    datacount = this.size.width/100;  
	      //number of random datapoints to be generated; keep in mind this.size.width is around 600 or so.
    
	//Generate random numbers for the datapoints in the chart:
    ...
    .attr("transform", "translate(" + this.padding.left + "," + this.padding.top + ")");
	 ...
	 //This bit allows you to drag around the plot, but also does datapoint circles somehow:
...
//    .attr("class", "line")
    ...
    //Allow click-and-drag of datapoints vertically?  Maybe?
...
//Drag graph OR DATAPOINT back & forth in X -- why the same code??
...
//Drag graph OR DATAPOINT up & down in Y -- why the same code??
