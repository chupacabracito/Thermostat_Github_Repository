...
edx_d3CreateStackedBarGraph = function(parameters, svg, divTooltip) {
  ...
  // Add y0 and y1 of the y-axis based on the count and order of the colorRange gradient.
...
// if you want to hard-code graph range---   graph.state.yRange = [0, 200];


  // Make the scales -- to define Y axis
  graph.scale = {
    x: d3.scale.ordinal()
