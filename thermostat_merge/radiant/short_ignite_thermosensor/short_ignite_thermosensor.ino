...
int thermosensor = A1;
int SetpointHeat = 60;
int SetpointCool = 65;  // maybe make independent later
...
////////////////////////////////////////ACCELEROMETER
  ...
  */
  ...
  // NOTE: This is probably where the bug is coming from
  /*
 ...
 ////////////////////////////////// HEATING / COOLING CONTROL
  ...
  Serial.print(String(SetpointHeat) + " ");//int(fahrenheit_rad-15)) + "°F ");
  Serial.print(String(SetpointCool) + " ");//int(fahrenheit_air-15)) + "°F ");
  Serial.println(String(int(OperativeTemp))+"°F ");
  ...
  */
  //done reading for setpoint change
    /*
    Serial.print("      OperativeTemp: ");  Serial.print(OperativeTemp);  
